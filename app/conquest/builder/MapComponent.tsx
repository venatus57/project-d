            ...
            {linePoints.length >= 2 && (
                <>
                    <Polyline
                        ...
                        pathOptions={{ color: "#d84fc4", weight: 14, opacity: 0.18, lineCap: "round", lineJoin: "round" }}
                    />
                    <Polyline
                        positions={linePoints}
                        pathOptions={{ color: "#d84fc4", weight: 4, opacity: 0.95, lineCap: "round", lineJoin: "round" }}
                    />
                </>
            )}
