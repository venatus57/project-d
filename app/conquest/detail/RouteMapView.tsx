            ...
            {linePoints.length >= 2 && (
                <>
                    <Polyline
                        ...
                        pathOptions={{ color: "#d84fc4", weight: 16, opacity: 0.15, lineCap: "round", lineJoin: "round" }}
                    />
                    <Polyline
                        positions={linePoints}
                        pathOptions={{ color: "#d84fc4", weight: 5, opacity: 0.95, lineCap: "round", lineJoin: "round" }}
                    />
                </>
            )}
